...
```bash
pip install https://github.com/pt-kompas-media-nusantara/streamlit-keycloak/releases/download/v1.2.0/streamlit_keycloak-1.2.0-py3-none-any.whl
```

### Install directly from GitHub
```bash
pip install git+https://github.com/pt-kompas-media-nusantara/streamlit-keycloak.git
```
